...
// import PriceSection from '@/components/landing/pricing-section'; // Remove static import
// import ContactSection from '@/components/landing/contact-section'; // Remove static import
...
export default function HomePage() {
  ...
  return (
    <div >
      <HeroSection />
      <AboutSection />
      <DynamicPriceSection /> {/* Use the dynamic component */}
      <DynamicContactSection /> {/* Use the dynamic component */}
    </div>
  );
}