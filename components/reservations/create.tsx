...
export default function CreateReservation() {
  ...
  const checkAvailability = async () => {
    ...
    try {
      const result = await getAvailability({
        ...
        entryTime: `${formData.entryDate}T${formData.entryTime}:00Z`,
        exitTime: `${formData.exitDate}T${formData.exitTime}:00Z`,
      });
  ...
  const handleReservation = async () => {
    ...
    setError("");
    try {
      // Adapt to ReservationData interface
      const reservationPayload = {
        code: "", // code will be generated by backend
        user_name: `${formData.firstName} ${formData.lastName}`.trim(),
        user_email: formData.email,
        user_phone: formData.phone,
        vehicle_type_id: 0, // You need to map formData.vehicleType to its ID, e.g. with a lookup table
      ...
      // Example mapping (replace with your real mapping)
